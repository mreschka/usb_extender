...
/****************************************************************************
  Function:
    void USBHostGenericRead( uint8_t deviceAddress, uint8_t ep, uint8_t *buffer, uint32_t length )
  ...
  Parameters:
    uint8_t deviceAddress  - USB Address of the device.
    uint8_t ep             - Endpoint to read from
  ...
  Example:
    ...
    {
        USBHostGenericRead( deviceAddress,endpoint, &buffer, sizeof(buffer) );
    }
    </code>
...
/****************************************************************************
  ...
  Example:
    ...
    {
        USBHostGenericWrite( deviceAddress, endpoint, &buffer, sizeof( buffer ) );
    }
    </code>
...
/****************************************************************************
  Function:
    void USBHostGenericWrite( uint8_t deviceAddress, uint8_t ep, uint8_t *buffer, uint32_t length )
  ...
  Parameters:
    uint8_t deviceAddress   - USB Address of the device.
    uint8_t ep              - Endpoint to write to
    uint8_t *buffer         - Pointer to the data buffer
    uint32_t length         - Number of bytes to be transferred
